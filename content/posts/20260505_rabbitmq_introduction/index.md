...
1. **Direct**: <span id="exchange-direct-id">Este</span> tipo exchange publica a mensagem direto na fila. Caso nenhum exchange seja criado ou utilizado, o Direct será utilizado automaticamente. Neste exchange, a **Routing Key** é utilizada contendo o nome exato da fila;
